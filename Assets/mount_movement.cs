...
using System.Collections.Generic;
     ...
     class mount_movement : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (isRotating)
            {
                float rotationX = source.transform.localEulerAngles.y + Input.GetAxis("Mouse X") * mouseSensitivity;
                rotationY -= Input.GetAxis("Mouse Y") * mouseSensitivity;
                rotationY = Mathf.Clamp(rotationY, -90, 90);
                source.transform.localEulerAngles = new Vector3(rotationY, rotationX, 0.0f);
            }
            ...
            source.transform.Translate(p);
            newPosition.x = source.transform.position.x;
            newPosition.z = source.transform.position.z;
            newPosition.y = source.transform.position.y;
